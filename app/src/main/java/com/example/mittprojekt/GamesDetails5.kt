...
class GamesDetails5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_games_details5)

        sharedPreferences = getSharedPreferences("MyPrefs5", Context.MODE_PRIVATE)
        ...
        button.setOnClickListener {
            ...
            Toast.makeText(this@GamesDetails5, "Rating is $message", Toast.LENGTH_SHORT).show()
        }
