...
class GamesDetails7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_games_details7)

        sharedPreferences = getSharedPreferences("MyPrefs7", Context.MODE_PRIVATE)
        ...
        button.setOnClickListener {
            ...
            Toast.makeText(this@GamesDetails7, "Rating is $message", Toast.LENGTH_SHORT).show()
        }
