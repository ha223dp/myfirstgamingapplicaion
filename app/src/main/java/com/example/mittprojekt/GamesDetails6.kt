...
class GamesDetails6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_games_details6)

        sharedPreferences = getSharedPreferences("MyPrefs6", Context.MODE_PRIVATE)
        ...
        button.setOnClickListener {
            ...
            Toast.makeText(this@GamesDetails6, "Rating is $message", Toast.LENGTH_SHORT).show()
        }
