...
class GamesDetails3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_games_details3)

        sharedPreferences = getSharedPreferences("MyPrefs3", Context.MODE_PRIVATE)
        ...
        button.setOnClickListener {
            ...
            Toast.makeText(this@GamesDetails3, "Rating is $message", Toast.LENGTH_SHORT).show()
        }
