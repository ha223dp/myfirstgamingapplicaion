...
class GamesDetails4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_games_details4)
        ...
        button.setOnClickListener {
            ...
            Toast.makeText(this@GamesDetails4, "Rating is $message", Toast.LENGTH_SHORT).show()
        }
